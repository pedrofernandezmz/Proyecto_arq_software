...
<div obj={product} key={product.product_id} className="product">
    ...
    <button className="addcart" onClick={() => addToCart(product.product_id, setCartItems)}>COMPRAR</button>
  ...
  return (
    <div className="home">
      ...
      <div id="main">
        ...
        {products.length > 0 ? showProducts(products, setCartItems) : <a> error </a>}
